const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Calculator-cUUxLM2v.js","assets/index-DSe8Tsld.js","assets/index-Bpgp8LVY.css","assets/Calculator-Cw_soDSg.js"])))=>i.map(i=>d[i]);
import{n as e,r as t,wt as n}from"./index-DSe8Tsld.js";t(`tnt/V5/Calculator`,async function(){return(await n(async()=>{let{default:e}=await import(`./Calculator-cUUxLM2v.js`);return{default:e}},__vite__mapDeps([0,1,2]))).default}),t(`tnt/V5/HC/Calculator`,async function(){return(await n(async()=>{let{default:e}=await import(`./Calculator-Cw_soDSg.js`);return{default:e}},__vite__mapDeps([3,1,2]))).default}),e(`Calculator`,{dialogSvg:`<svg width="169" height="160" viewBox="0 0 169 160" fill="none" xmlns="http://www.w3.org/2000/svg" id="tnt-Dialog-Calculator">
