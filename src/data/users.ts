...
export const ALL_FEATURES = [
  ...
  { id: 'pi_access',     name: 'Access Process Intelligence' },
  { id: 'pi_create',     name: 'Process Intelligence: Create Process' },
  { id: 'pi_data_int',   name: 'Process Intelligence: Access Data Integration' },
  { id: 'pi_data_mod',   name: 'Process Intelligence: Access Data Modeling' },
  { id: 'pi_odata',      name: 'Process Intelligence: Access SIGNAL OData API' },
  { id: 'pi_widget',     name: 'Process Intelligence: Export Widget Data' },
  { id: 'governance',    name: 'Access Process Governance' },
