...
export const dictionaryItems: DictionaryItem[] = [
  ...
  // scr-matching items for suggestion demo
  { id:'d95', name:'Screen Application',      type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:8,  description:'Screen and review incoming job applications against criteria',        version:'1.2', lastUpdated:'09.03.2026', status:'published', updatedBy:'Lisa Wang',      usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d96', name:'Screen References',       type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:6,  description:'Screen and verify candidate professional references',                 version:'1.0', lastUpdated:'10.03.2026', status:'published', updatedBy:'Lisa Wang',      usedIn:['Recruitment Process'] },
  { id:'d97', name:'Candidate shortlisted',   type:'Events',     subCategory:'Intermediate Event', elementType:'event', usageCount:5, description:'Intermediate event when candidate passes initial screening stage',   version:'1.1', lastUpdated:'11.03.2026', status:'published', updatedBy:'Alex Turner',    usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d98', name:'Technical Screening',     type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:7,  description:'Conduct technical screening to assess candidate skills and competency', version:'2.0', lastUpdated:'12.03.2026', status:'published', updatedBy:'Sarah Chen',     usedIn:['Recruitment Process','Engineering Hiring'] },
  { id:'d99', name:'Screening Scorecard',     type:'Documents',  subCategory:'HR Information',  elementType:'data',  usageCount:4,  description:'Structured scorecard for recording screening interview outcomes',     version:'1.3', lastUpdated:'08.03.2026', status:'published', updatedBy:'Lisa Wang',      usedIn:['Recruitment Process'] },
  { id:'d100', name:'Pre-screening Call',          type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:9,  description:'Initial phone screening to assess candidate fit and availability',                  version:'1.5', lastUpdated:'07.03.2026', status:'published', updatedBy:'HR Manager',     usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d101', name:'Screen for Cultural Fit',     type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:5,  description:'Screen candidate alignment with company values and cultural expectations',          version:'1.0', lastUpdated:'06.03.2026', status:'published', updatedBy:'HR Manager',     usedIn:['Recruitment Process'] },
  { id:'d102', name:'Initial CV Screen',           type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:11, description:'Perform initial screening of submitted CVs against minimum job requirements',       version:'2.1', lastUpdated:'05.03.2026', status:'published', updatedBy:'Lisa Wang',      usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d103', name:'Phone Screen',                type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:8,  description:'Conduct a brief phone screen to verify candidate interest and basic qualifications', version:'1.3', lastUpdated:'04.03.2026', status:'published', updatedBy:'Sarah Chen',     usedIn:['Recruitment Process'] },
  { id:'d104', name:'Screen Diversity Criteria',   type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:4,  description:'Review applications against diversity and inclusion screening criteria',             version:'1.0', lastUpdated:'03.03.2026', status:'draft',     updatedBy:'HR Manager',     usedIn:['Recruitment Process'] },
  { id:'d105', name:'Screening Decision',          type:'Gateway',    subCategory:'Recruitment',     elementType:'gateway', usageCount:7, description:'Gateway deciding whether candidate passes the screening stage',                     version:'1.2', lastUpdated:'10.03.2026', status:'published', updatedBy:'Alex Turner',    usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d106', name:'Video Screen Interview',      type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:6,  description:'Conduct asynchronous or live video screening interview with shortlisted candidates', version:'1.1', lastUpdated:'11.03.2026', status:'published', updatedBy:'Sarah Chen',     usedIn:['Recruitment Process'] },
  { id:'d107', name:'Screening Passed',            type:'Events',     subCategory:'Intermediate Event', elementType:'event', usageCount:5, description:'Intermediate event triggered when candidate successfully passes all screening steps', version:'1.0', lastUpdated:'09.03.2026', status:'published', updatedBy:'Lisa Wang',      usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d108', name:'Automated Resume Screening',  type:'Activities', subCategory:'Recruitment',     elementType:'task',  usageCount:9,  description:'Use ATS to automatically screen resumes based on keyword and criteria matching',     version:'2.0', lastUpdated:'08.03.2026', status:'published', updatedBy:'IT Admin',       usedIn:['Recruitment Process','Hiring Pipeline'] },
  { id:'d109', name:'Screening Report',            type:'Documents',  subCategory:'HR Information',  elementType:'data',  usageCount:3,  description:'Document summarising screening outcomes and recommendations for each candidate',      version:'1.0', lastUpdated:'07.03.2026', status:'draft',     updatedBy:'Lisa Wang',      usedIn:['Recruitment Process'] },
  { id:'d110', name:'Screening Criteria Document', type:'Documents',  subCategory:'HR Information',  elementType:'data',  usageCount:6,  description:'Document defining the mandatory and desirable criteria used for candidate screening',  version:'1.4', lastUpdated:'06.03.2026', status:'published', updatedBy:'HR Manager',     usedIn:['Recruitment Process','Policy Management'] },
]
