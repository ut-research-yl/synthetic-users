...
export default function TemplateSideNavPage() {
  ...
  return (
    <>
      <DynamicPage
        ...
        titleArea={
          <DynamicPageTitle>
            <Title slot="heading" level="H3">Side Nav + Content</Title>
            <Text slot="subheading">Use for detail pages with categorical left navigation.</Text>
          </DynamicPageTitle>
        }
        footerArea={
      ...
      >
        <div ref={layoutRef} className={p.sidenavLayout}>
          ...
          <div className={`${p.sidenavContent} ${p.narrowContent}`}>
