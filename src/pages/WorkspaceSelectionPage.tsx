...
const WORKSPACES = [
  ...
  { id: 'demo-sap', label: 'Demo Workspace (GA)' },
  { id: 'jm-user-testing', label: 'JM User Testing' },
  { id: 'jira-mining', label: 'Jira Mining' },
  { id: 'plug-gain', label: 'Plug and Gain - Demo Workspace' },
  { id: 'pre-release', label: 'Pre Release Production 2026' },
  { id: 'global-demo', label: 'Global Demo Workspace' },
  { id: 'leanix', label: 'LeanIX Integration' },
  { id: 'modeling', label: 'Modeling and Governance Workspace' },
  { id: 'pe-learning', label: 'P&E Learning Workspace' },
  { id: 'process-explorer', label: 'Process Explorer' },
  { id: 'dev-testing', label: 'Process Manager (Dev Testing)' },
  { id: 'peyman', label: 'Process Manager (Peyman Badakhshan)' },
  { id: 'ai-demo', label: 'Process Manager AI Demospace - 1' },
  ...
  { id: 'customer-ops', label: 'Customer & Operations Lifecycle', sso: true },
  { id: 'sap-playground', label: 'Playground', sso: true },
  { id: 'signavio-production', label: 'Process Manager Production', sso: true },
]
