...
import type { Widget, ExternalWidget, Metric } from '../components/DataPanel'
...
export default function ModelerLayout() {
  ...
  const [selectedWidget, setSelectedWidget] = React.useState<Widget | ExternalWidget | Metric | null>(null)
