...
const DICT_ITEMS: DictItem[] = [
  ...
  { id: 'd90', name: 'ProcureNet',             category: 'IT System',          elementType: 'artifact', subCategory: 'Procurement', description: 'Cloud procurement and supply chain management platform', lastUpdated: '14.03.2026' },
