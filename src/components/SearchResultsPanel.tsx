...
export const RESULTS: ResultItem[] = [
  {
    id: 'a1',
    name: 'HR Hiring Process GER',
    objectType: 'Process Model',
    typeName: 'BPMN (Complete) + Live Insights',
    description: 'End-to-end hiring workflow for the German entity. Covers CV evaluation, interviews, offer management and onboarding with Live Insights data integration.',
    lastUpdateBy: 'Claire Westfield',
    lastUpdateDate: 'Jul 17, 2026',
    createdDate: 'Jan 10, 2026',
    version: '8.6.1.2',
    folder: 'HR / Recruitment',
    comments: 3,
    isFavorite: true,
